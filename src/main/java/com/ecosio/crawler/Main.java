...
public class Main {
    ...
    public static void main(String[] args) throws URISyntaxException {
        ...
        int depth = args.length > 1 && Integer.parseInt(args[1]) > 0 ? Integer.parseInt(args[1]) : 1;
        int timeOut = args.length > 2 && Integer.parseInt(args[2]) > 0 ? Integer.parseInt(args[2]) : 10;
